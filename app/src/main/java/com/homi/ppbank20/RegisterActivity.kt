                            ...
                            auth.createUserWithEmailAndPassword(
                                ...
                                OnCompleteListener<AuthResult> { task ->
                                    if (task.isSuccessful) {
                                        ...
                                        user.incomes.put("type01", "0")
                                        user.incomes.put("type02", "0")
                                        user.incomes.put("type03", "0")
                                        user.incomes.put("type04", "0")
                                        user.expenses.put("type04", "0")
                                        user.expenses.put("type01", "0")
                                        user.expenses.put("type02", "0")
                                        user.expenses.put("type03", "0")
                                        user.expenses.put("type04", "0")
